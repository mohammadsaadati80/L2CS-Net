...
def draw_gaze(width, a,b,c,d,image_in, pitchyaw, thickness=2, color=(255, 255, 0),sclae=2.0):
...
def render(frame: np.ndarray, results: GazeResultContainer, width, height, border_points):
    ...
    for i in range(results.pitch.shape[0]):
        ...
        # draw_gaze(width, x_min,y_min,bbox_width, bbox_height,frame,(pitch,yaw),color=(0,0,255))
        image_out, dx, dy = draw_gaze(width, x_min,y_min,bbox_width, bbox_height,frame,(pitch,yaw),color=(0,0,255))
...
def render2(frame: np.ndarray, results: GazeResultContainer, width, height):
    ...
    for i in range(results.pitch.shape[0]):
        ...
        width, a,b,c,d,image_in, pitchyaw, thickness, color, sclae = width, x_min,y_min,bbox_width, bbox_height,frame,(pitch,yaw), 2, (0,0,255) , 2.0
